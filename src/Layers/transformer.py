...
class TransformerModel(torch.nn.Module):
    ...
    def __init__(self, args, model_eval=False):
        ...
        self.args = args
        print(f"Transformer {self.args['nattblocks']} attention block(s), {self.args['hidden_dim']} hidden dimensions, {self.args['nheads']} head(s) without input/output embedding")
