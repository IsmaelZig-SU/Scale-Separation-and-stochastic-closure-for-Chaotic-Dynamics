...
class Autoencoder(nn.Module):
    ...
    def __init__(self, args, model_eval = False):
        ...
        self.args = args
        print(f"AE_Model: new BIG VAE network, {self.args['num_obs']} observables, KLD regularization (beta) : {self.args['beta_VAE']}")
